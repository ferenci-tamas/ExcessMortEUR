...
```{r, echo = FALSE}
ggplot(resFull[nuts_level==0&age=="TOTAL"&sens==FALSE&ED=="ExPost"&model=="quasipoisson" & geo == "HU"],
...
```{r, echo = FALSE}
ggplot(resFull[nuts_level==0&age=="TOTAL"&sens==FALSE&ED=="ExPost"&model=="quasipoisson" & geo == "HU" & date >= "2023-01-01"],
       aes(x = date, y = excess/population*1e6)) +
  geom_line() +
  geom_hline(yintercept = 0, color = "blue") +
  labs(x = "", y = "Aktuális többlethalálozás [fő/1M fő]", caption = captionlab) +
...
```{r, echo = FALSE}
ggplot(resFull[nuts_level==0&age=="TOTAL"&sens==FALSE&ED=="ExPost"&model=="quasipoisson"],
       aes(x = date, y = excess/population*1e6, group = geo, label = geo)) +
  geom_line(aes(color = geo=="HU",
                group = forcats::fct_reorder(geo, geo=="HU", .fun = first))) +
  geom_hline(yintercept = 0, color = "blue") +
...
```{r, echo = FALSE}
ggplot(resFull[nuts_level==0&age=="TOTAL"&sens==FALSE&ED=="ExPost"&model=="quasipoisson" & date >= "2023-01-01"],
       aes(x = date, y = excess/population*1e6, group = geo, label = geo)) +
  geom_line(aes(color = geo=="HU",
                group = forcats::fct_reorder(geo, geo=="HU", .fun = first))) +
  geom_hline(yintercept = 0, color = "blue") +
...
```{r, echo = FALSE}
ggplot(resFull[age=="TOTAL"&(nuts_level==3|geo=="HU")&sens==FALSE&ED=="ExPost"&model=="quasipoisson"],
       aes(x = date, y = excess/population*1e6, group = geoname, label = geoname)) +
  geom_line(aes(color = geo=="HU",
                group = forcats::fct_reorder(geo, geo=="HU", .fun = first))) +
  geom_hline(yintercept = 0, colour = "blue") +
...
```{r, echo = FALSE}
ggplot(resFull[age=="TOTAL"&(nuts_level==3|geo=="HU")&sens==FALSE&ED=="ExPost"&model=="quasipoisson" & date >= "2023-01-01"],
       aes(x = date, y = excess/population*1e6, group = geoname, label = geoname)) +
  geom_line(aes(color = geo=="HU",
                group = forcats::fct_reorder(geo, geo=="HU", .fun = first))) +
  geom_hline(yintercept = 0, colour = "blue") +
